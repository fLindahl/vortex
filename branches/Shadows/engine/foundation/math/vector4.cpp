...
*/
vec4
vec4::clamp(__Float4Arg vClamp, __Float4Arg vMin, __Float4Arg vMax)
{
...
*/
float
vec4::angle(const vec4 & v0, const vec4 &v1)
{
    ...
    float cangle = vec4::unpack_x(dot);
    return cosf(cangle);
}
...
*/
vec4
vec4::select( const vec4& v0, const vec4& v1, const vec4& control )
{
