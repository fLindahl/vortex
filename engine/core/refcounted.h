...
/**
    ...
    The common base class of Vortex, based on Nebula3's refcount system. 
	Implements a strong refcounted
    mechanism and runtime type information. checks at
