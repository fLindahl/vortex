...
public:
    ...
    /// constructor
    Rtti(const char* className, Util::FourCC fcc, Creator creatorFunc, const Core::Rtti* parentClass, int instSize);
    /// legacy constructor without FourCC for Mangalore compatibility
    Rtti(const char* className, Creator creatorFunc, const Core::Rtti* parentClass, int instSize);
    /// equality operator
...
private:
    ...
    void Construct(const char* className, Util::FourCC fcc, Creator creatorFunc, const Core::Rtti* parentClass, int instSize);
