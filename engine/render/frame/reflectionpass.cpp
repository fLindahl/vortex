...
void ReflectionPass::Setup()
{
	...
	glFramebufferTexture2D(GL_FRAMEBUFFER, GL_COLOR_ATTACHMENT0, GL_TEXTURE_2D, this->reflectionBuffer, 0);
	...
	_assert(e == GL_FRAMEBUFFER_COMPLETE, "Reflectionpass Framebuffer Status Error!");
