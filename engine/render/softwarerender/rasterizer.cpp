...
//}
//
//Edge::Edge(Math::vec4 v1, Math::vec4 v2)
//{
//	if (v1[1] < v2[1])
//	{
//		xb = (int)floor(v1[0]);
...
//}
//
//void Rasterizer::setVertexShader(const std::function<Math::Vector3(const Math::mat4& pMat, const Math::mat4& tMat, const MeshResource::Vertex& vertex, Math::vec4& outVert)>& func)
//{
